 ...
 * Copyright (C) 2024-2025 Elisha Victor
 *
...
FILE *fopen_soloader(char *fname, char *mode) {
    ...
    else if (strcmp(fname, "ux0:/data/sonic4") == 0) {
        return open_soloader("ux0:/data/sonic4", mode);
    }
     else if (strcmp(fname, "ux0:/data/sonic4/sonic4ep2.obb") == 0) {
        return open_soloader("ux0:/data/sonic4/sonic4ep2.obb", mode);
    }
...
int open_soloader(char *_fname, int flags) {
    ...
    else if (strcmp(_fname, "/dev/urandom") == 0) {
        return open_soloader("app0:/", flags);
    }
    else if (strcmp(_fname, "dP ") == 0) {
        return open_soloader("app0:/", flags);
    }
    else if (strcmp(_fname, "ux0:/data/sonic4") == 0) {
        return open_soloader("ux0:/data/sonic4", flags);
    }
       else if (strcmp(_fname, "ux0:/data/sonic4/sonic4ep2.obb") == 0) {
        return open_soloader("ux0:/data/sonic4/sonic4ep2.obb", flags);
    }
